...
urlpatterns = [
    ...
    path(
        ...
        views.download_students_pdf,
        name='students_pdf'
    ),

    path(
        'download-fee-report/',
        views.download_fee_report,
        name='fee_report'
    ),
    ...
    path(
        'attendance/',
        views.attendance_batches,
        name='attendance_batches'
    ),

    path(
        'attendance/<int:batch_id>/',
    ...
    path(
        'operations/exams/create/',
        views.create_exam,
        name='create_exam'
    ),

    path(
        'operations/exams/library/',
        views.exam_library,
        name='exam_library'
    ),
    ...
    path(
        'questions/',
        question_views.question_dashboard,
        name='question_dashboard'
    ),

    path(
        'questions/add/',
        question_views.create_question,
